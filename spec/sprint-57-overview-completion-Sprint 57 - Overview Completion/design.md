...
- **dark_theme:** El canvas usa verde carbón, los paneles separan superficie base/elevada/seleccionada y el verde claro queda reservado para enlaces y foco. El lienzo cartográfico permanece claro para preservar el contraste de la escala de riesgo; sus controles usan una superficie oscura coherente. La landing pública conserva su paleta editorial aunque exista una preferencia oscura guardada.
