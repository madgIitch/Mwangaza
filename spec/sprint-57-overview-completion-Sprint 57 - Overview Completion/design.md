...
- **dark_theme:** El canvas usa verde carbón, los paneles separan superficie base/elevada/seleccionada y el verde claro queda reservado para enlaces y foco. El lienzo cartográfico usa una superficie oscura neutra y conserva los colores semánticos exclusivamente en las unidades, leyenda y estados. La landing pública conserva su paleta editorial aunque exista una preferencia oscura guardada.
